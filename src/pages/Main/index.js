      ...
      <Box sx={{ marginBottom: "2rem" }}>
        <Grid container alignItems="center" flexDirection="column">
          ...
          <Box className={classes.wrapName}>
            <h1 className={classes.name}>DƯƠNG VĂN DŨNG</h1>
          </Box>
      ...
      <Card className={classes.card}>
          <CardContent className={classes.card_content}>
            <Grid container alignItems="center">
              ...
              <Link className={classes.link_content} target="_blank" href="https://zalo.me/84963794339">Zalo</Link>
            </Grid>
          </CardContent>
        </Card>
        <Card className={classes.card}>
          <CardContent className={classes.card_content}>
            <Grid container alignItems="center">
              ...
              <Link className={classes.link_content} target="_blank" href="https://www.facebook.com/profile.php?id=100074760610847">Facebook</Link>
            </Grid>
          </CardContent>
        </Card>
        <Card className={classes.card}>
        ...
        <Card className={classes.card}>
          <CardContent className={classes.card_content}>
            <Grid container alignItems="center">
              ...
              <Link className={classes.link_content} target="_blank" href="tel:+84963794339">Phone number</Link>
            </Grid>
          </CardContent>
        </Card>
      </Box>
